...
import static net.fabiszewski.agpxa.Alert.showAlert;
import static net.fabiszewski.agpxa.Alert.showConfirm;
import static net.fabiszewski.agpxa.GpxExportService.GPX_EXTENSION;
import static net.fabiszewski.agpxa.GpxExportService.GPX_MIME;

/**
 * Main activity of agpxa
 *
 */
