...
/**
 * Service synchronizing local database positions with remote Ebs-spec.
 *
 */
...
public class WebSyncService extends IntentService {
    ...
    public static final String BROADCAST_SYNC_FAILED = "net.fabiszewski.agpxa.broadcast.sync_failed";
    public static final String BROADCAST_SYNC_DONE = "net.fabiszewski.agpxa.broadcast.sync_done";
    ...
    /**
     * Get track id
     * If the track hasn't been registered on Ebs-spec yet,
     * set up new track on the Ebs-spec and get new id
     * @return Track id
     */
