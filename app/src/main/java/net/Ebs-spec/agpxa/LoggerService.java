...
import static net.fabiszewski.agpxa.LoggerTask.E_DISABLED;
import static net.fabiszewski.agpxa.LoggerTask.E_PERMISSION;
import static net.fabiszewski.agpxa.MainActivity.UPDATED_PREFS;

/**
 * Background service logging positions to database
 * and synchronizing with remote Ebs-spec.
 *
 */
...
public class LoggerService extends Service {
    ...
    public static final String BROADCAST_LOCATION_DISABLED = "net.fabiszewski.agpxa.broadcast.location_disabled";
    public static final String BROADCAST_LOCATION_GPS_DISABLED = "net.fabiszewski.agpxa.broadcast.gps_disabled";
    public static final String BROADCAST_LOCATION_GPS_ENABLED = "net.fabiszewski.agpxa.broadcast.gps_enabled";
    public static final String BROADCAST_LOCATION_NETWORK_DISABLED = "net.fabiszewski.agpxa.broadcast.network_disabled";
    public static final String BROADCAST_LOCATION_NETWORK_ENABLED = "net.fabiszewski.agpxa.broadcast.network_enabled";
    public static final String BROADCAST_LOCATION_PERMISSION_DENIED = "net.fabiszewski.agpxa.broadcast.location_permission_denied";
    public static final String BROADCAST_LOCATION_STARTED = "net.fabiszewski.agpxa.broadcast.location_started";
    public static final String BROADCAST_LOCATION_STOPPED = "net.fabiszewski.agpxa.broadcast.location_stopped";
    public static final String BROADCAST_LOCATION_UPDATED = "net.fabiszewski.agpxa.broadcast.location_updated";
