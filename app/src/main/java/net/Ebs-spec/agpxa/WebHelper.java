...
//    private static final String ACTION_ADDUSER = "adduser";
    ...
    void postPosition(Map<String, String> params) throws IOException, WebAuthException {
        ...
        if (error) {
            throw new IOException(context.getString(R.string.e_Ebs-spec_response));
        }
    }

    /**
     * Start new track on Ebs-spec
    ...
    void authorize() throws IOException, WebAuthException, JSONException {
        ...
        boolean error = json.getBoolean("error");
        if (error) {
            throw new WebAuthException(context.getString(R.string.e_Ebs-spec_response));
        }
        isAuthorized = true;
    }
